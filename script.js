...
var min = 10;
if (min >= 0 && min <= 14) {console.log('в первую четверть часа');}
if (min >= 15 && min <= 30) {console.log('во вторую четверть часа');}
if (min >= 31 && min <= 45) {console.log('в третью четверть часа');}
if (min >= 46 && min <= 59) {console.log('в четвертую четверть часа');}
